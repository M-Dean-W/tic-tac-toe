...
function checkWin() {
    if (cells[0].textContent === 'X' && cells[1].textContent === 'X' && cells[2].textContent === 'X'
        ...
        || cells[2].textContent === 'X' && cells[5].textContent === 'X' && cells[8].textContent === 'X') { alert(`${currentPlayer} has won the game`); gameOver++; return }
        ...
        || cells[2].textContent === 'O' && cells[5].textContent === 'O' && cells[8].textContent === 'O') { alert(`${currentPlayer} has won the game`); gameOver++; return }
